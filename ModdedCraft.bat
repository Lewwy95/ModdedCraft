...
powershell -c "(Invoke-WebRequest -URI 'https://raw.githubusercontent.com/Lewwy95/ModdedCraft/main/version.txt').Content | Set-Content -Path '%~dp0\bin\Temp\version_new.txt'"
cls
...
:: Not Installed
echo ModdedCraft is not installed! Installing...
timeout /t 2 /nobreak >nul
cls
goto install
...
powershell -c "(New-Object System.Net.WebClient).DownloadFile('https://github.com/Lewwy95/ModdedCraft/archive/refs/heads/main.zip','%~dp0\bin\Temp\ModdedCraft-main.zip')"
cls

:: Extract Latest Revision
echo Extracting latest revision...
powershell -c "Expand-Archive '%~dp0\bin\Temp\ModdedCraft-main.zip' -Force '%~dp0\bin\Temp'"
cls
...
xcopy /s /y "%~dp0\bin\Temp\ModdedCraft-main" "%~dp0"
cls

:: Apply New Version File
break>version.txt
powershell -c "(Invoke-WebRequest -URI 'https://raw.githubusercontent.com/Lewwy95/ModdedCraft/main/version.txt').Content | Set-Content -Path '%~dp0\version.txt'"
cls
...
mkdir "%~dp0..\Interface\AddOns\!ScreenResolutionDropdownFix"
